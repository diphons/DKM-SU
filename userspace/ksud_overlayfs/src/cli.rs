...
enum Commands {
    ...
    /// Install DKM-SU userspace component to system
    Install {
        #[arg(long, default_value = None)]
        magiskboot: Option<PathBuf>,
    },

    /// Uninstall DKM-SU modules and itself(LKM Only)
    Uninstall {
    ...
    /// Patch boot or init_boot images to apply DKM-SU
    BootPatch {
    ...
    /// Restore boot or init_boot images patched by DKM-SU
    BootRestore {
        /// boot image path, if not specified, will try to find the boot image automatically
        #[arg(short, long)]
        boot: Option<PathBuf>,
...
enum Debug {
    ...
    SetManager {
        ...
        #[arg(default_value_t = String::from("com.diphons.dkmsu"))]
        apk: String,
    },
...
pub fn run() -> Result<()> {
    ...
    android_logger::init_once(
        Config::default()
            ...
            .with_tag("DKM-SU"), // logs will show under mytag tag
    );
