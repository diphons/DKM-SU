...
import com.diphons.dkmsu.ui.util.uninstallModule
import com.diphons.dkmsu.ui.util.restoreModule
import com.diphons.dkmsu.ui.viewmodel.ModuleViewModel
import com.diphons.dkmsu.ui.webui.WebUIActivity
                        ...
                        if (hasWebUi) {
                            webUILauncher.launch(
                                Intent(context, WebUIActivity::class.java)
                                    .setData(Uri.parse("dkm-su://webui/$id"))
                                    .putExtra("id", id)
                                    .putExtra("name", name)
                            )
                        }
