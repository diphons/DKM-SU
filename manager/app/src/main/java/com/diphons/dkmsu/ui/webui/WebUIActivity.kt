package com.diphons.dkmsu.ui.webui
...
class WebUIActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
            ...
            setTaskDescription(ActivityManager.TaskDescription("DKM-SU - $name"))
        } else {
            val taskDescription = ActivityManager.TaskDescription.Builder().setLabel("DKM-SU - $name").build()
        ...
        val webView = WebView(this).apply {
            ...
            loadUrl("https://mui.dkm-su.org/index.html")
        }
