...
package com.diphons.dkmsu.ui.uibench;
...
public class RenderingJitter extends Activity {
    ...
    public static final int code1 = R.id.jitter_mma;
    public static final int code2 = R.id.totalish_mma;
    public static final int code3 = R.id.ui_frametime_mma;
    public static final int code4 = R.id.rt_frametime_mma;
    public static final int code5 = R.id.total_mma;
    ...
    public static final class PointGraphView extends View {
        ...
        float[] mJitterYs = new float[JITTER_LINES_MS.length];
        float mLabelWidth;
        float mLabelHeight;
        float mDensity;
        float mGraphScale;
    ...
    private static final class AnimatedBackgroundDrawable extends Drawable {
        private static final int FROM_COLOR = 0x0018FFFF;
        private static final int TO_COLOR = 0x0040C4FF;
