...
public class SpfConfig {
    ...
    public static String WAKELOCK_BLOCKER = "wakelock_blocker";
    ...
    public static String BATTERY_NOTIF_MODE = "battery_notif_mode";
    public static String BYPASS_CHARGING = "bypass_charging";
    ...
    public static String SWAP_BOOT = "swap_boot";
